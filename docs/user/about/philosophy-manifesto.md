...
- **Campfire Sync** — Physical proximity is the ultimate encryption. Devices on the same network discover each other and sync directly—no cloud, no relay, no middleman.
