...
|---------|------------|-------|
| Quick Switcher | Low | Cmd+O/E navigation through recent objects; command palette may suffice |
...
| Workspaces | High | Significant query/view restructuring |
| Voice Notes + Whisper | High | Audio recording, local ML transcription |
| Smart Auto-linking | Medium | Text analysis, real-time link suggestions |
