...
export const navigationActions: PaletteAction[] = [
  ...
  {
    id: CREATE_FROM_TEMPLATE_ACTION_ID,
    label: 'Create from Template',
    icon: 'clipboard',
    category: 'action',
  },
  {
    id: NEW_TEMPLATE_ACTION_ID,
    label: 'New Template',
    icon: 'sparkles',
    category: 'action',
  },
  {
    id: OPEN_IN_SPLIT_ACTION_ID,
    label: 'Open in Split View',
    icon: 'columns-2',
    category: 'action',
  },
  {
    id: DUPLICATE_OBJECT_ACTION_ID,
    label: 'Duplicate Object',
    icon: 'copy',
    category: 'action',
  },
  {
    id: KEYBOARD_SHORTCUTS_ACTION_ID,
