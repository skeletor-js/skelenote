...
fn draw_tabs(f: &mut Frame, app: &App, area: Rect) {
    ...
    if app.view == View::Search {
        spans.push(Span::styled(" │ ", app.theme.tab_divider));
        spans.push(Span::styled("[/]Search", app.theme.tab_active));
    }
            ...
            .map(|(line_num, line)| {
                ...
                if is_cursor_line && is_editing {
                    ...
                    Line::from(vec![
                        ...
                        Span::styled(cursor_char.to_string(), app.theme.content_cursor),
...
fn draw_status(f: &mut Frame, app: &App, area: Rect) {
    ...
    let style = match app.input_mode {
        ...
        InputMode::MetadataEditing => app.theme.status_bar_mode_meta,
    };
