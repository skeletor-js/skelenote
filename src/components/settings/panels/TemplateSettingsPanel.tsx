 ...
 *
 * Wrapper for the existing TemplateSettings component with panel header.
 * Promotes Daily Note Template to the top.
 */

import { useState, useCallback } from 'react';
import { Stack, Group, Text, Box, Select, Badge, Button, Divider } from '@mantine/core';
...
export function TemplateSettingsPanel() {
  ...
  return (
    <Stack gap="lg">
      <Box>
        <Text size="lg" fw={600} mb="xs">Templates</Text>
      ...
      <Box>
        <Group justify="space-between" align="center" mb="md">
          <Text size="sm" fw={500}>All Templates</Text>
          <Button
            variant="light"
            size="xs"
