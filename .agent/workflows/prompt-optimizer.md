...
Convert requirements to EARS patterns. See `prompt-optimizer-refs/ears_syntax.md` for complete syntax rules.
...
Match requirements to established frameworks. See `prompt-optimizer-refs/domain_theories.md` for full catalog.
...
For complex scenarios, see `prompt-optimizer-refs/advanced_techniques.md`:
...
- **`prompt-optimizer-refs/ears_syntax.md`** - Complete EARS syntax rules, all 5 patterns, transformation guidelines, benefits
- **`prompt-optimizer-refs/domain_theories.md`** - 40+ theories mapped to 10 domains (productivity, UX, gamification, learning, e-commerce, security, etc.)
- **`prompt-optimizer-refs/examples.md`** - Four complete transformation examples (procrastination app, e-commerce product page, learning dashboard, password reset security) with before/after comparisons and reusable template
- **`prompt-optimizer-refs/advanced_techniques.md`** - Multi-stakeholder requirements, non-functional specs, complex conditional logic patterns
